 ...
 *
 * Vendored into this project via the Canvas UI shadcn registry
 * (npx shadcn@latest add @canvas-ui/...). Used as part of an application,
 * as the licence permits; not redistributed as a component library.
 */
